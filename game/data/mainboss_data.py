...
MAIN_BOSS_POOL = [
    # 1. ELEMENT: VOID | RACE: COSMIC
    {
        ...
        "race": "cosmic", 
        "attack_type": "magic",
        "base_hp": 8500, "p_atk": 120, "m_atk": 220, "p_def": 90, "m_def": 120, 
        "speed": 8, "dodge_chance": 0.2, "crit_chance": 0.25, "crit_damage": 2.0,
        "status_resistance": {"all": 0.5, "stun": 1.0, "paralyze": 1.0}, 
        "ai_behavior": "trickster", 
        "exp": 10000, "gold": 5000,
        "skill": {"name": "Absolute Eradication", "type": "drain_all", "chance": 0.35}, 
        "drops": [{"id": "keeper_crown", "chance": 1.0}, {"id": "void_grimoire", "chance": 0.5}],
    ...
    # 2. ELEMENT: WATER | RACE: BEAST
    {
        ...
        "base_hp": 12000, "p_atk": 240, "m_atk": 150, "p_def": 150, "m_def": 100, 
        "speed": 4, "dodge_chance": 0.05, "crit_chance": 0.15, "crit_damage": 2.5,
        "status_resistance": {"freeze": 1.0, "bleed": 1.0}, 
        "ai_behavior": "aggressive", 
        "exp": 12000, "gold": 6000,
        "skill": {"name": "Tsunami of Despair", "type": "stun", "chance": 0.4}, 
        "drops": [{"id": "leviathan_scale", "chance": 1.0}, {"id": "oceanic_trident", "chance": 0.3}],
    ...
    # 3. ELEMENT: FIRE | RACE: UNDEAD
    {
        ...
        "race": "undead", 
        "attack_type": "magic",
        "base_hp": 7500, "p_atk": 160, "m_atk": 230, "p_def": 110, "m_def": 90, 
        "speed": 7, "dodge_chance": 0.15, "crit_chance": 0.3, "crit_damage": 2.2,
        "status_resistance": {"burn": 1.0, "poison": 1.0}, 
        "ai_behavior": "berserk", 
        "exp": 11000, "gold": 5500,
        "skill": {"name": "Incinerate", "type": "burn", "chance": 0.5}, 
        "drops": [{"id": "ashen_heart", "chance": 1.0}, {"id": "hellfire_blade", "chance": 0.4}],
    ...
    {
        "name": "CHRONOS DEVOURER", 
        "element": "earth", 
        "weakness": "ice", 
        "race": "anomaly", 
        "attack_type": "physical",
        "base_hp": 9000, "p_atk": 210, "m_atk": 100, "p_def": 180, "m_def": 150, 
        "speed": 10, "dodge_chance": 0.25, "crit_chance": 0.2, "crit_damage": 1.8,
        "status_resistance": {"stun": 1.0, "paralyze": 1.0, "blind": 1.0}, 
        "ai_behavior": "defensive", 
        "exp": 13000, "gold": 7000,
        "skill": {"name": "Time Fracture", "type": "confuse", "chance": 0.35}, 
        "drops": [{"id": "chronos_sand", "chance": 1.0}, {"id": "time_bender_ring", "chance": 0.25}],
    ...
    {
        "name": "THE FIRST WEAVER", 
        "element": "light", 
        "weakness": "dark", 
        "race": "humanoid", 
        "attack_type": "magic",
        "base_hp": 10000, "p_atk": 190, "m_atk": 250, "p_def": 130, "m_def": 160, 
        "speed": 9, "dodge_chance": 0.3, "crit_chance": 0.3, "crit_damage": 2.5,
        "status_resistance": {"all": 0.8}, 
        "ai_behavior": "trickster", 
        "exp": 20000, "gold": 10000,
        "skill": {"name": "Erase Reality", "type": "drain_all", "chance": 0.4}, 
        "drops": [{"id": "first_weaver_soul", "chance": 1.0}, {"id": "the_archivus_key", "chance": 1.0}],
    ...
    {
        "name": "JAMES MARCUS ECHO", 
        "element": "poison", 
        "weakness": "fire", 
        "race": "slime", 
        "attack_type": "magic",
        "base_hp": 8200, "p_atk": 140, "m_atk": 240, "p_def": 100, "m_def": 150, 
        "speed": 5, "dodge_chance": 0.1, "crit_chance": 0.2, "crit_damage": 1.8,
        "status_resistance": {"poison": 1.0, "bleed": 1.0, "blind": 0.5}, 
        "ai_behavior": "defensive", 
        "exp": 10500, "gold": 5200,
        "skill": {"name": "Progenitor Strain", "type": "poison", "chance": 0.55}, 
        "drops": [{"id": "t_virus_vial", "chance": 1.0}, {"id": "leech_charm", "chance": 0.4}],
    ...
    {
        "name": "ORPHAN OF THE ARCHIVES", 
        "element": "blood", 
        "weakness": "lightning", 
        "race": "demon", 
        "attack_type": "physical",
        "base_hp": 6800, "p_atk": 260, "m_atk": 100, "p_def": 120, "m_def": 80, 
        "speed": 9, "dodge_chance": 0.35, "crit_chance": 0.4, "crit_damage": 3.0,
        "status_resistance": {"bleed": 1.0, "fear": 1.0}, 
        "ai_behavior": "berserk", 
        "exp": 11500, "gold": 5800,
        "skill": {"name": "Placenta Slam", "type": "bleed", "chance": 0.45}, 
        "drops": [{"id": "orphan_umbilical_cord", "chance": 1.0}, {"id": "kos_parasite", "chance": 0.2}],
    ...
    # 8. ELEMENT: DARK | RACE: ANOMALY
    {
        ...
        "race": "anomaly", 
        "attack_type": "magic",
        "base_hp": 7800, "p_atk": 90, "m_atk": 260, "p_def": 140, "m_def": 180, 
        "speed": 8, "dodge_chance": 0.4, "crit_chance": 0.15, "crit_damage": 1.5,
        "status_resistance": {"fear": 1.0, "blind": 1.0, "stun": 0.5}, 
        "ai_behavior": "trickster", 
        "exp": 12500, "gold": 6500,
        "skill": {"name": "Sleep Paralysis", "type": "paralyze", "chance": 0.5}, 
        "drops": [{"id": "nightmare_essence", "chance": 1.0}, {"id": "dreamcatcher_amulet", "chance": 0.35}],
    ...
    # 9. ELEMENT: LIGHTNING | RACE: CONSTRUCT
    {
        ...
        "race": "construct", 
        "attack_type": "physical",
        "base_hp": 11000, "p_atk": 220, "m_atk": 180, "p_def": 200, "m_def": 110, 
        "speed": 3, "dodge_chance": 0.0, "crit_chance": 0.2, "crit_damage": 2.0,
        "status_resistance": {"poison": 1.0, "bleed": 1.0, "paralyze": 1.0}, 
        "ai_behavior": "defensive", 
        "exp": 14000, "gold": 7500,
        "skill": {"name": "Overcharge Protocol", "type": "armor_break", "chance": 0.4}, 
        "drops": [{"id": "leviathan_gear", "chance": 1.0}, {"id": "tesla_coil", "chance": 0.4}],
    ...
    # 10. ELEMENT: ICE | RACE: GOD
    {
        ...
        "race": "god", 
        "attack_type": "magic",
        "base_hp": 9500, "p_atk": 150, "m_atk": 270, "p_def": 160, "m_def": 200, 
        "speed": 6, "dodge_chance": 0.2, "crit_chance": 0.3, "crit_damage": 2.5,
        "status_resistance": {"freeze": 1.0, "burn": 0.5, "fear": 1.0}, 
        "ai_behavior": "aggressive", 
        "exp": 16000, "gold": 8000,
        "skill": {"name": "Absolute Zero Eclipse", "type": "freeze", "chance": 0.45}, 
        "drops": [{"id": "sovereign_crown", "chance": 1.0}, {"id": "frozen_galaxy", "chance": 0.25}],
